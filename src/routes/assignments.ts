...
export const createAssignmentsRouter = (assignmentsController?: AssignmentsController): IRouter => {
  const router: IRouter = Router();

  const _assignmentsController =
    assignmentsController ?? container.resolve<AssignmentsController>('assignmentsController');
